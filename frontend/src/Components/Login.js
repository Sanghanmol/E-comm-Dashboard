...
const Login = () => {
    ...
    const handleLogin = async () => {
        console.log("email,password,repeatPassword", email, password, repeatPassword)
    ...
    return (
        <div className='login'>
            <div className="formBox">
                ...
                <input className="inputBox" type="password" value={repeatPassword} onChange={(e) => setRepeatPassword(e.target.value)} placeholder="Repeat Password" required />
